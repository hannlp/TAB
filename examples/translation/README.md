...
torch.hub.list('pytorch/fairseq')  # [..., 'transformer.wmt16.en-de.mustc.en-de', ... ]

# Load a transformer trained on WMT'16 En-De
# Note: WMT'19 models use fastBPE instead of subword_nmt, see instructions below
en2de = torch.hub.load('pytorch/fairseq', 'transformer.wmt16.en-de.mustc.en-de',
...
```python
en2de = torch.hub.load('pytorch/fairseq', 'transformer.wmt19.mustc.en-de',
...
fairseq-generate data-bin/wmt14.mustc.en-fr.newstest2014  \
    --path data-bin/wmt14.mustc.en-fr.fconv-py/model.pt \
